...
func (h *HTTPClientMock) ListInfo() ([]byte, error) {
...
func (h *HTTPClientMock) ListContainers() ([]byte, error) {
...
func (h *HTTPClientMock) ListImages() ([]byte, error) {
...
func (h *HTTPClientMockError) ListInfo() ([]byte, error) {
...
func (h *HTTPClientMockError) ListContainers() ([]byte, error) {
...
func (h *HTTPClientMockError) ListImages() ([]byte, error) {
