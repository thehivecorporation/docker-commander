...
// GetInfo is the mocked Get implementation of http.Get
...
//GetContainers returns a byte array with containers data
func (h *HTTPClientMock) GetContainers() ([]byte, error) {
...
//GetImages returns a byte array with images data
func (h *HTTPClientMock) GetImages() ([]byte, error) {
...
// GetInfo is the mocked Get implementation of http.Get with errors
func (h *HTTPClientMockError) GetInfo() ([]byte, error) {
	str := `{"ID":"","Containers":102,"Driver":"","DriverStatus":`
	byt := []byte(str)
	return byt, nil
}

//GetContainers returns a byte array with containers data with errors
func (h *HTTPClientMockError) GetContainers() ([]byte, error) {
	str := `[{"Id":"6514d918bc01b0df8098053086c72cf9e4e3f0b166987b5b5db78d1f6b783ea8`
	byt := []byte(str)
	return byt, nil
}

//GetImages returns a byte array with images data with errors
func (h *HTTPClientMockError) GetImages() ([]byte, error) {
