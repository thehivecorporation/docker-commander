...
//DockerClientParserMock parser mock
type DockerClientParserMock struct{}

// ParseContainer parses a []byte to dockerclient.Container objects
func (d *DockerClientParserMock) ParseContainer(cs *[]byte) ([]dockerclient.Container, error) {
...
func (d *DockerClientParserMock) ParseInfo(i *[]byte) (dockerclient.Info, error) {
